...
[_QWERTY] = LAYOUT_ortho(
    ...
    CTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    AA_K,    AA_L,    KC_SCLN, KC_QUOT,
...
[_NAV] = LAYOUT_ortho(
    ...
    _______, _______, _______,  _______, KC_VOLD, _______, _______, KC_MPLY, KC_MPRV,  KC_MNXT, _______, _______,
 ...
 * | Del  | F13  |  M9  |      |      |      |      |   _  |   +  |   {  |   }  |  |   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  M7  |  M8  |  M1  |  M2  |      |  M6  |  M3  | Prev | Home | End  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Nump  |      |      |      |      |             |      |      | Bri- | Bri+ |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_ortho(
    ...
    KC_DEL,  KC_F13,  ATOM_M9, _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, ATOM_M7, ATOM_M8, ATOM_M1, ATOM_M2, _______, ATOM_M6, ATOM_M3, KC_MPRV, KC_HOME, KC_END,  _______,
