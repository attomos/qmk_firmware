...
[_LAYER0] = LAYOUT_tkl_ansi(
  ...
  LCTL_T(KC_ESC),   KC_A,   AA_S,   AA_D,   KC_F,   KC_G,   KC_H,   KC_J,   AA_K,   AA_L,KC_SCLN,KC_QUOT,         KC_ENT,
...
[_LAYER1] = LAYOUT_tkl_ansi(
  ...
  BL_TOGG,  BL_STEP,  BL_INC,  BL_DEC,  KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
