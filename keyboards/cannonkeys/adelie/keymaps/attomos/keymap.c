...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
    ...
    KC_LSFT,  AA_Z,   AA_X,    KC_C,    KC_V,    KC_B,    KC_N,   KC_M,    AA_COMM, KC_DOT,  AA_SLSH,  KC_RSFT, KC_UP, TG(_LAYER2),
  ...
  [_LAYER1] = LAYOUT_all(
    ...
    _______, ATOM_M7, _______, ATOM_M1, ATOM_M2, _______, ATOM_M6, ATOM_M3, _______, KC_HOME, KC_END, _______, _______, _______,
